...
function Header() {
  //3. consuming context
  //usecontext return zthe all the value of the context object that is provided by the provider. In this case, we are destructuring the value to get the onClearPosts function.
