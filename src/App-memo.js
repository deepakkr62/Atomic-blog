...
const Archive = memo(function Archive({
  ...
  // function passed into useState (which generates the posts) is only called once, on the initial render. So we use this
  // trick as an optimization technique, because if we just used a regular variable, these posts would be re-created on every render.
